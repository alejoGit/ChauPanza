...
<div>
	<div class="columns">
		<div class="column col-sm-10 col-xl-10 col-mx-auto">
			<h2 class="text-center">Guía de alimentación</h2>
		</div>
	</div>
			...
			<div class="modal-header">
				...
				<div class="columns">
					<div class="column col-sm-10 col-xl-4 col-mx-auto">
						...
						<br>
						<button class="btn btn-primary" @click="onClickChooseForToday">ELEGÍR PARA HOY</button>
					</div>
				</div>
		...
		methods: {
			...
			onClickChooseForToday(){
				...
				if(this.currentFood > 0){
					...
					axios.post(api.setFoodUser, postData)
					.then(res => {
						this.loading = false
